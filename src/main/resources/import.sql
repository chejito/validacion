...
INSERT INTO users (fullname, username, email, password, phone, url_dni1, url_dni2, validated) VALUES ('User User', '01234567H', 'user@user.com', '$2a$10$Vq7lBeLShnuk8VNbHA5FwesrbJH6loPkfbhBZWKfZCLKGua1w7nn.', '6158-123-587', 'https://res.cloudinary.com/validacion-rest-api-env/image/upload/v1638116636/sxfn0bwoqevo44e1fj80.png', 'https://res.cloudinary.com/validacion-rest-api-env/image/upload/v1638116637/x48tgj7aicp7tm5q9x9m.png', TRUE);
INSERT INTO users (fullname, username, email, password, phone, url_dni1, url_dni2, validated) VALUES ('User2 User2', '23456789J', 'user2@user.com', '$2a$10$rjkCs8JROMfbMpF4s4ue/es4ExOMD2iVHpvJ3n0vaBnVnVAAmu7py', '432-11-11-234', 'https://res.cloudinary.com/validacion-rest-api-env/image/upload/v1638117190/ublzeu588dsdm6voenxb.png', 'https://res.cloudinary.com/validacion-rest-api-env/image/upload/v1638117191/vsrei6ig3vfkrn2euovp.png', FALSE);
